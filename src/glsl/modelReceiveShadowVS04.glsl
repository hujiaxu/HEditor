...
#define LOG_DEPTH#define SHADOW_MAP
...
vec4 czm_updatePositionDepth(vec4 coords) {
  ...
  v_logPositionEC = logPositionEC;#endif                            
...
struct ProcessedAttributes{    vec3 positionMC;};
...
void initializeAttributes(out ProcessedAttributes attributes){    attributes.positionMC = a_positionMC;}
