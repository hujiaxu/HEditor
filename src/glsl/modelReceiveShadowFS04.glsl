...
void featureIdStage(out FeatureIds featureIds, ProcessedAttributes attributes) {
  ...
  initializeFeatureIds(featureIds, attributes);  initializeFeatureIdAliases(featureIds);  setFeatureIdVaryings();
}
void metadataStage(
...
void czm_log_depth_main(){
  ...
  #endif        
  gl_PointSize *= show;    
  #endif    gl_Position = show * positionClip;
}
#line 0
void main() { 
