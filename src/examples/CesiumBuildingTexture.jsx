import { Ion, Viewer, CustomShader, VaryingType, TextureUniform, UniformType, Cesium3DTileset, LightingModel, Cesium3DTileColorBlendMode, ImageryLayer, BingMapsImageryProvider, } from "cesium";
    ...
    useEffect(() => {
        const cb = async () => {
            ...
            try {
                ...
                defaultAction();
                tileset.customShader = createShader("https://seopic.699pic.com/photo/40250/3918.jpg_wh1200.jpg");
            }
            catch (error) {
...
//# sourceMappingURL=CesiumBuildingTexture.jsx.map